package com.westonsublett.bugtracker.config;

import com.westonsublett.bugtracker.BugTrackerApplication;
...
public class MariaDBConfig extends AbstractR2dbcConfiguration {
    ...
    private final Config config = BugTrackerApplication.getConfig();
